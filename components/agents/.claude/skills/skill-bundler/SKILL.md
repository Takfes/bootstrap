...
```bash
python package_skills.py /path/to/skill1 /path/to/skill2 --dest /output/directory --dry-run
```
...
| `--dest` | Yes** | Destination directory for zip files and copied skills |
...
**: Required when packaging (not needed with `--list`)
